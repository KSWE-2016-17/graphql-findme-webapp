                ...
                <div className="row">
                    <div className="col-md-10 col-md-offset-1">
                            <table class="table" style={{width: "100%", border: "1px solid lightgrey"}}>
                                ...
                                <tr colspan="2">
                                    <td>
                                        <textarea  name="Text1" rows="15" style={{width:"100%", border:"2px solid lightblue"
                                       }}>
                                ...
                                <tr>
                                    <div className="row">
                                        <div className="col-md-10">
                                            <button className="btn btn-warning btn-md" type="button"><span className="glyphicon glyphicon-floppy-disk"></span> Archivieren</button>
                                        </div>
                                        <div className="col-md-1">
                                            <button className="btn btn-danger btn-md" type="button"><span className="glyphicon glyphicon-trash"></span> Löschen</button>
                                        </div>
                                    </div>
                                </tr>
                            </table>
