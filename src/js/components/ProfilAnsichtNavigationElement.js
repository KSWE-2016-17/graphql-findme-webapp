                    ...
                    <div>
                        ...
                        <div className="collapse navbar-collapse" id="myNavbar">
                            <ul className="nav navbar-nav">
                                <li><a href="#/profile"><span className="glyphicon glyphicon-user"></span> Profil</a>
                                </li>
                                <li><a href="#/dating"><span className="glyphicon glyphicon-send"></span> Dating</a>
                                </li>
                            ...
                            <ul className="nav navbar-nav navbar-right">
                                <li><a href="#/settings"><span className="glyphicon glyphicon-wrench"></span>
                                    Einstellungen</a>
                                </li>
                                <li><a href="#/logout"><span className="glyphicon glyphicon-log-out"></span>
                                    Ausloggen</a>
                                </li>
                            </ul>
                        </div>
